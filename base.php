...
,
    ...
    public function getOrderShippingCost($params, $shipping_cost)
    {
        ...
        if (!$this->auth() && !in_array($service->correios_code, \AgCorreiosServices::$free_module_services)) {
            return false;
        }
    ...
    public function simulateAllCarriersForProduct($postcode, $id_product, $id_product_attribute = 0, $quantity = 1)
    {
        ...
        foreach ($services as $service) {
            if (!$this->auth() && !in_array($service->correios_code, \AgCorreiosServices::$preactivated_services)) {
                continue;
            }
